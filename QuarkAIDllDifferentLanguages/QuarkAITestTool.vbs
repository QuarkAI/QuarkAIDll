...
sub rewrite
	...
	MyResponse = MyResponse + "<hr></div>"
	MyResponse = MyResponse + "<div>Window operation functions without binding:<br>"
	...
	MyResponse = MyResponse + "<p>Window: Handle = <input type=text id=WindowHandleWithoutBind size=4 value=" + cstr(WindowHandleWithoutBind) + ">, X = <input type=text id=WindowXWithoutBind size=1 value=" + cstr(WindowXWithoutBind) + ">, Y = <input type=text id=WindowYWithoutBind size=1 value=" + cstr(MouseYWithoutBind) + ">, <input id=MoveWindowWithoutBind type=button value=MoveWindow>, Width = <input type=text id=ClientWidthWithoutBind size=1 value=" + cstr(ClientWidthWithoutBind) + ">, Height = <input type=text id=ClientHeightWithoutBind size=1 value=" + cstr(ClientHeightWithoutBind) + ">, <input id=SetClientSize type=button value=SetClientSize>.</p></div>"
